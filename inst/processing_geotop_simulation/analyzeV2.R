...
wpath <- '/home/ecor/Dropbox/R-packages/geotopsim_simulations/Vc_SC/Vc_SC2_002' 
#wpath_outputdata <- paste(wpath_pkg,"processing_geotop_simulation/output",sep="/")
wpath_outputdata <- "/home/ecor/Dropbox/Public/geotop_intercomparison/Vc_SC2_002"
...
file.output.csv <- paste(wpath_outputdata,"geotop.Vc_Sc2.output.csv",sep="/")
...
file.nctheta <-  paste(wpath_outputdata,"geotop.theta.Vc_Sc2.nc",sep="/")
file.ncpsi <- paste(wpath_outputdata,"geotop.soilwaterpressure.Vc_Sc2.nc",sep="/")
file.nchsup <- paste(wpath_outputdata,"geotop.surfacewater.Vc_Sc2.nc",sep="/")
##
