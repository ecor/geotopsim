...
wpath <- '/home/ecor/local/geotop_dev/geotop/tests/3D/hillslope01'  ####	"/home/ecor/Dropbox/R-packages/geotopsim_simulations/geotop_simulation_suberslab_anisotropic" ######		paste(wpath_pkg,"geotop_simulation",sep="/")

soilprop_tmp <- read.table(paste(wpath_inputdata,"soilprop_hillslope01.txt",sep="/"),sep=",",header=TRUE) 
#######
...
write.table(soilprop_tmp,paste(wpath_inputdata,"soilprop_hillslope01.txt",sep="/"),sep=",",quote=FALSE,row.names=FALSE) 
