...
wpath_output <- "/home/ecor/ownCloud/giacomo_emanuele_cordano/Intercomparison/Superslab_NEWSUPERSLAB"
...
if (loadDataFromPackage==TRUE) { 
	...
	save(list=c("psi","theta","hsup"),file=paste(wpath_data,"PsiTheta_NEWSUPERSLAB.rda",sep="/"))
